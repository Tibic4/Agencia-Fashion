      ...
      <main className="flex-1 pt-32 pb-20">
        <div className="container max-w-3xl">
          ...
          <div className="prose space-y-4 text-sm leading-relaxed" style={{ color: "var(--muted)" }}>
            ...
            <p>As fotos enviadas são processadas por APIs de IA terceirizadas (Anthropic, Fashn.ai, OpenAI, Stability AI) exclusivamente para geração da campanha. Não usamos suas imagens para treinar modelos.</p>
