...
const plans = [
  ...
  },
  {
    ...
    regen: 5,
    history: "Ilimitado",
    features: ["Tudo do Pro", "3 modelos virtuais", "5 regenerações/camp", "Histórico ilimitado", "Suporte WhatsApp"],
    notIncluded: ["Marca branca"],
  },
  {
    name: "Agência",
    ...
    regen: 5,
    history: "Ilimitado",
    features: ["Tudo do Business", "5 modelos virtuais", "Marca branca", "API pública", "Suporte prioritário"],
    notIncluded: [],
  },
];
