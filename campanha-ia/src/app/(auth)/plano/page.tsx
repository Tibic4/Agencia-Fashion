    ...
    <div className="animate-fade-in-up">
      ...
      <div className="mt-12 mb-8 flex flex-col items-center justify-center opacity-70 hover:opacity-100 transition-opacity">
        <div className="flex items-center gap-1.5 mb-2">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: "var(--success, #22c55e)" }}>
        ...
        <div className="flex items-center gap-1.5" aria-label="Processado pelo Mercado Pago">
          <span className="text-xs font-semibold" style={{ color: "var(--muted)" }}>Checkout oficial</span>
          <svg width="65" viewBox="0 0 100 28" fill="#009EE3">
