...
export default function Plano() {
  ...
  return (
    <div className="animate-fade-in-up">
      ...
      <div className="mt-12 mb-8 flex flex-col items-center justify-center transition-opacity hover:opacity-100 opacity-90">
        <div className="flex items-center gap-2 mb-3">
          <div className="flex items-center justify-center w-5 h-5 rounded-full" style={{ background: "rgba(34, 197, 94, 0.1)" }}>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: "var(--success, #22c55e)" }}>
        ...
        <div className="flex items-center gap-3 px-4 py-2.5 rounded-xl backdrop-blur-md" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.05)" }}>
          ...
          <div className="flex items-center" aria-label="Processado pelo Mercado Pago">
            {/* Logo do Mercado Pago em cor oficial envolto num badge luxuoso para não destoar do modo noturno */}
            <svg width="65" viewBox="0 0 100 28" fill="#009EE3" className="block drop-shadow-sm">
