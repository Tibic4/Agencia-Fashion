  ...
  const testimonials = [
    {
      ...
      quote: "Antes eu perdia 2h descendo nas costas da minha vendedora pra ela tirar foto. Hoje uso o manequim que fica no canto da loja e o CriaLook converte em fotos absurdas. Vendi todas as 15 peças do lote no primeiro teste de Meta Ads.",
          ...
          >
            ...
            <div className="flex items-center gap-3 mt-auto border-t border-border pt-4 sm:pt-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full overflow-hidden shrink-0 border-2 border-brand-200 dark:border-brand-800">
                <Image src={t.photo} alt={t.name} width={48} height={48} className="w-full h-full object-cover" unoptimized />
              </div>
