...

{
  ...
  "vto_fabric_descriptor": "Descrição técnica CONCISA em INGLÊS do tecido para reprodução fotográfica pelo Gemini VTO (ex: 'ribbed knit with visible vertical channels, matte finish, medium weight' ou 'lightweight chiffon, semi-transparent, fluid drape'). Foque na TEXTURA VISÍVEL, acabamento e peso do tecido.",
...
REGRAS POR OBJETIVO (siga RIGOROSAMENTE):
${params.objetivo === "venda_imediata" ? `→ VENDA IMEDIATA: Foco 100% em conversão. Ângulo = benefício direto da peça. Gatilho OBRIGATÓRIO: "desejo" ou "escassez". Tom: energético ou urgente. CTA: "Chama no Direct", "Garanta a sua", "Peça o seu". Preço DEVE ser destaque central. Contra-objeção: custo-benefício.` : ""}${params.objetivo === "lancamento" ? `→ LANÇAMENTO: Foco em novidade e exclusividade. Ângulo = "acabou de chegar" / "primeira vez". Gatilho OBRIGATÓRIO: "novidade" ou "exclusividade". Tom: sofisticado ou divertido. CTA: "Seja a primeira", "Já disponível", "Confira a novidade". Use palavras: estreia, nova coleção, recém-chegado. Gere FOMO (medo de perder).` : ""}${params.objetivo === "promocao" ? `→ PROMOÇÃO: Foco em urgência e oportunidade. Ângulo = economia / preço especial. Gatilho OBRIGATÓRIO: "urgencia" ou "escassez". Tom: urgente. CTA: "Corre que acaba", "Aproveite agora", "Últimas unidades". REGRA: se não tem % de desconto informado, NÃO invente — use apenas "preço especial", "condição única", "oportunidade". Destaque o preço com ênfase (negrito, emoji 🔥).` : ""}${params.objetivo === "engajamento" ? `→ ENGAJAMENTO: Foco em interação e comunidade. Ângulo = opinião / identificação / diversão. Gatilho OBRIGATÓRIO: "prova_social" ou "desejo". Tom: acolhedor ou divertido. CTA: "Comenta aqui", "Marca aquela amiga", "Qual você prefere?". Inclua OBRIGATORIAMENTE: pelo menos 1 pergunta nos textos, estímulo a comentar/compartilhar. Stories devem ter formato de enquete ou "isso ou aquilo".` : ""}
