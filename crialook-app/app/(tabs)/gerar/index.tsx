...
const styles = StyleSheet.create({
  ...
  photoSmall: { flex: 1, borderRadius: tokens.radii.md },
  ...
  modelCard: { width: 100, alignItems: 'center', borderRadius: tokens.radii.lg, borderWidth: 2, overflow: 'hidden' },
  ...
  chip: { paddingHorizontal: tokens.spacing.mdLg, paddingVertical: tokens.spacing.md, borderRadius: tokens.radii.xxl, borderWidth: 1, minHeight: 40 },
  ...
  filterTab: { paddingHorizontal: tokens.spacing.mdLg, paddingVertical: tokens.spacing.md, borderRadius: tokens.radii.xxl, borderWidth: 1, minHeight: 40 },
